...
namespace Tools
{
    public static class HttpHelper
    {
        ...
        /// <returns></returns>
        public static (string, HttpHeaders) HttpPostWithHeader(string url, string postData = null, string contentType = "application/json", int timeOut = 30, Dictionary<string, string> headers = null)
        {
            postData = postData ?? "";
            using (HttpClient client = new HttpClient())
            {
                ...
                using (HttpContent httpContent = new StringContent(postData, Encoding.UTF8))
                {
                    ...
                    return (response.Content.ReadAsStringAsync().Result, response.Headers);
                }
            }
        }
        ...
        /// <param name="headers">填充消息头</param>
        /// <returns></returns>
        public static (string, HttpHeaders) HttpPostWithHeader(string url, Dictionary<string, string> postData = null, Dictionary<string, Stream> postFile = null, int timeOut = 30, Dictionary<string, string> headers = null)
        {
            using (HttpClient client = new HttpClient())
            {
                if (headers != null)
        ...
        /// <param name="headers">填充消息头</param>
        /// <returns></returns>
        public static async Task<(string, HttpHeaders)> HttpPostAsyncWithHeader(string url, string postData = null, string contentType = "application/json", int timeOut = 30, Dictionary<string, string> headers = null)
        {
            postData = postData ?? "";
            using (HttpClient client = new HttpClient())
            {
        ...
        /// <returns></returns>
        public static (string, HttpHeaders) HttpGetWithHeader(string url, string contentType = "application/json", Dictionary<string, string> headers = null)
        {
            using (HttpClient client = new HttpClient())
            {
                if (contentType != null)
        ...
        /// <param name="contentType"></param>
        /// <returns></returns>
        public static async Task<(string, HttpHeaders)> HttpGetAsyncWithHeader(string url, string contentType = "application/json", Dictionary<string, string> headers = null)
        {
            using (HttpClient client = new HttpClient())
            {
                if (contentType != null)
